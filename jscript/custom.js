...
$('#theme-content li').eq(3).click(function() {
	$('link[rel="StyleSheet"]').eq(0).attr('href', $('link[rel="StyleSheet"]').eq(0).attr('href').replace(/\/[^\/]+$/, '') + '/yellow-border.css');
});
